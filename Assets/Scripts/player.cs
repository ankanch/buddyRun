...
public class player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!inverse_y)
        {
            if (Input.GetKey(KeyCode.UpArrow) && stateInfo.fullPathHash == runStateHash) //控制上面那个人移动
            {
                sr.material.color = Color.white;
                antor.SetBool(keypressHash, true);
                audioSource.Play();
        ...
        {
            if (Input.GetKey(KeyCode.DownArrow) && stateInfo.fullPathHash == runStateHash) //控制上面那个人移动
            {
                sr.material.color = Color.white;
                antor.SetBool(keypressHash, true);
                audioSource.Play();
